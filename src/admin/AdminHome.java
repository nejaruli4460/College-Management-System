...
//		this is for admin
		...
		TotalCount.TotalNotificationAll(notificationCount);
		...
		JLabel lblNewLabel = new JLabel("Last Login:  "+Method.lastLoginTime(serial, "admin"));
		lblNewLabel.setForeground(Color.WHITE);
		lblNewLabel.setBounds(882, 75, 247, 14);
		upperBackground.add(lblNewLabel);
		try {
			Connection con=Connector.connect();
			String query="select name from admin where sl="+serial;
