...
public class MessageUs extends JPanel {
	...
	static int  startingMessage=Method.countTotalMessage();
...
//			
//				adminMain main=new adminMain(serial,1);
		...
		sendButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					ps.setString(3, Method.usernameBySerialAdmin(serial));
...
//		panel.add(label);
		...
		try {
			...
			ps.setString(2, Method.usernameBySerialAdmin(serial));
			ps.setString(3, "all");
			ps.setString(4, Method.usernameBySerialAdmin(serial));
...
//				model.addRow(list.toArray());
				if(rs.getString(1).equalsIgnoreCase(Method.usernameBySerialAdmin(serial))) {
