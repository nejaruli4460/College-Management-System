...
public class MessageUs extends JPanel {
	...
	public int startingMessage=Method.countTotalMessage();
...
//				refreshRecievedMessage(serial,panelRec);
		...
		sendButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(recField.getText().equals("")) {
					...
					Reciever=Reciever.concat(recField.getText().toUpperCase());
				}
				try {
					...
					ps.setString(3, Method.usernameBySerialFaculty(serial));
...
//		panel.add(label);
		...
		try {
			...
			ps.setString(2, Method.usernameBySerialFaculty(serial));
			ps.setString(3, "all");
			ps.setString(4, Method.usernameBySerialFaculty(serial));
...
//				model.addRow(list.toArray());
				if(rs.getString(1).equalsIgnoreCase(Method.usernameBySerialFaculty(serial))) {
