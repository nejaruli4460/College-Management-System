...
public class FacultyNotice extends JPanel {
	...
	public FacultyNotice() {
		...
		scrollPane.setBounds(0, 283, 1291, 400);
		add(scrollPane);
		...
		DefaultTableModel model=refreshRoutine();
	...
	public DefaultTableModel refreshRoutine() {
		...
		try {
			...
			String query="select memo,title,date from notice where ack='faculty' or ack='all' order by sl desc";
